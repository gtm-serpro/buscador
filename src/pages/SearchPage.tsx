    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b px-6 py-4 bg-white sticky top-0 z-10">
        <div className="flex items-center justify-between">
          ...
          {/* {hasSearched && (
            <Button variant="outline" size="sm" onClick={handleOpenSearch}>
              Nova busca
            </Button>
          )} */}
        </div>
      ...
      {/* Modal de Busca */}
      {showCommandModal && (
        <SearchCommand onSearch={handleSearch} onClose={handleCloseSearch} />
      )}
          ...
          <div className="flex items-center justify-center h-[calc(100vh-100px)]">
            <Empty>
              <EmptyHeader>
                ...
                <EmptyTitle>Comece sua busca</EmptyTitle>
                <EmptyDescription>
                  Clique no botão abaixo para abrir o buscador
                </EmptyDescription>
              </EmptyHeader>
              <EmptyContent>
                <Button onClick={handleOpenSearch}>Iniciar busca</Button>
              </EmptyContent>
            </Empty>
          </div>
        )}
